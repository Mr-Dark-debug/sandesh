...
// ==========================================
export const getSystemSettings = () => api.get("/system");

export const updateSystemSettings = (data) => api.put("/system", data);

export const getNamespaceWarnings = (newNamespace) =>
  api.get(`/system/namespace-warnings`, {
    params: { new_namespace: newNamespace },
  });
