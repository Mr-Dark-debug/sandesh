    ...
    <div className="h-full flex items-center justify-center bg-white">
      <div className="text-center px-8 py-16 max-w-lg">
        ...
        <p className="text-[#6B6B6B] leading-relaxed">
          Your local-first email system. Select a folder from the sidebar to
          view your messages, or click{" "}
          <span className="font-medium text-[#A3A380]">Compose</span> to write a
          new email.
        </p>

        {/* Quick tips */}
        <div className="mt-8 pt-6 border-t border-[#EFE8CE]">
          <p className="text-xs text-[#8B8B8B] uppercase tracking-wider mb-3">
            Quick Tips
          </p>
