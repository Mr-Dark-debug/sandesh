...
const CONFIRMATION_CONFIGS = {
  ...
  SIGN_OUT: {
    title: "Sign Out",
    description:
      "You will be signed out of Sandesh. Any unsaved drafts may be lost.",
  ...
  CREATE_USER: {
    title: "Create User",
    description:
      "A new user account will be created with the provided credentials.",
    confirmText: "Create",
    cancelText: "Cancel",
  ...
  DELETE_USER: {
    title: "Delete User",
    description:
      "This user account and all associated emails and folders will be permanently deleted. This action cannot be undone.",
  ...
  EMPTY_TRASH: {
    title: "Empty Trash",
    description:
      "All emails in Trash will be permanently deleted. This action cannot be undone.",
  ...
  DELETE_FOLDER: {
    title: "Delete Folder",
    description:
      "This folder will be deleted. All emails inside will be moved to Inbox.",
  ...
  CHANGE_NAMESPACE: {
    title: "Change Domain",
    description:
      "Changing the namespace will affect all email addresses in the system. Existing users may experience issues.",
    ...
    >
      ...
      >
        ...
        <div className="p-6">
          {/* Icon */}
          <div
            className={`w-14 h-14 rounded-2xl ${styles.iconBg} flex items-center justify-center mx-auto mb-5`}
          >
...
export function ConfirmationProvider({ children }) {
  ...
  return (
    <ConfirmationContext.Provider
      value={{ confirm, SEVERITY, CONFIGS: CONFIRMATION_CONFIGS }}
    >
      {children}
      <ConfirmationDialog
