        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              <a
                href="#features"
                className="text-sm font-medium text-[#6B6B6B] hover:text-[#3D3D3D] transition-colors"
              >
                Features
              </a>
              <a
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-[#6B6B6B] leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0">
                सनdesh is a self-hosted email system that runs entirely on your
                infrastructure. No cloud dependencies, no tracking, complete
                control.
              </p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex items-center gap-8">
              ...
              >
                ...
                <div>
                  <p className="text-xs text-[#8B8B8B] uppercase tracking-wider">
                    GitHub
                  </p>
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <p className="text-sm font-medium text-[#A3A380] uppercase tracking-wider mb-3">
              Features
            </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-2xl bg-[#F9FAFB] border border-[#E5E8EB] hover:shadow-lg transition-shadow">
              ...
              <p className="text-[#6B6B6B]">
                Your data never leaves your network. No cloud sync, no external
                servers, no tracking.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#F9FAFB] border border-[#E5E8EB] hover:shadow-lg transition-shadow">
              ...
              <p className="text-[#6B6B6B]">
                Create and manage users with clear roles. Admin controls for
            ...
            <div className="p-6 rounded-2xl bg-[#F9FAFB] border border-[#E5E8EB] hover:shadow-lg transition-shadow">
              ...
              <p className="text-[#6B6B6B]">
                Local SMTP means emails arrive instantly. No queues, no spam
                filters, no delays.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#F9FAFB] border border-[#E5E8EB] hover:shadow-lg transition-shadow">
              ...
              <p className="text-[#6B6B6B]">
                Single container deployment. Easy to run, backup, and manage on
                any infrastructure.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#F9FAFB] border border-[#E5E8EB] hover:shadow-lg transition-shadow">
              ...
              <p className="text-[#6B6B6B]">
                Clean, intuitive web interface. Compose, organize, and manage
                emails with ease.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-[#F9FAFB] border border-[#E5E8EB] hover:shadow-lg transition-shadow">
              ...
              <p className="text-[#6B6B6B]">
                Clear identity rules. Username-based addressing with
              ...
              <div className="grid md:grid-cols-3 gap-8 text-center">
                <div>
                  ...
                  <p className="text-sm text-[#6B6B6B]">
                    Run a single Docker container on your network
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="text-sm text-[#6B6B6B]">
                    Admin creates accounts with unique email addresses
                  </p>
                ...
                <div>
                  ...
                  <p className="text-sm text-[#6B6B6B]">
                    Send and receive emails within your network
                  </p>
                </div>
              </div>
              ...
              <div className="mt-12 pt-8 border-t border-[#E5E8EB]">
                <div className="bg-[#F9FAFB] rounded-xl p-6 font-mono text-sm text-center text-[#6B6B6B]">
                  <div className="flex items-center justify-center gap-4 flex-wrap">
                    <span className="px-4 py-2 bg-white rounded-lg border border-[#E5E8EB]">
                      Browser
                    </span>
                    <ChevronRight className="w-4 h-4 text-[#A3A380]" />
                    <span className="px-4 py-2 bg-[#A3A380] text-white rounded-lg">
                      सनdesh Server
                    </span>
                    <ChevronRight className="w-4 h-4 text-[#A3A380]" />
                    <span className="px-4 py-2 bg-white rounded-lg border border-[#E5E8EB]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex gap-4 p-6 rounded-2xl bg-[#F9FAFB] border border-[#E5E8EB]">
              ...
              <div>
                ...
                <p className="text-[#6B6B6B] text-sm">
                  Internal communication that stays internal. Perfect for
            ...
            <div className="flex gap-4 p-6 rounded-2xl bg-[#F9FAFB] border border-[#E5E8EB]">
              ...
              <div>
                <h3 className="font-semibold text-[#3D3D3D] mb-2">
                  Home Labs & Developers
                </h3>
                <p className="text-[#6B6B6B] text-sm">
                  Test email workflows without internet. Great for development
            ...
            <div className="flex gap-4 p-6 rounded-2xl bg-[#F9FAFB] border border-[#E5E8EB]">
              ...
              <div>
                ...
                <p className="text-[#6B6B6B] text-sm">
                  Spin up for time-limited events. No accounts to manage after
                  the event ends.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 p-6 rounded-2xl bg-[#F9FAFB] border border-[#E5E8EB]">
              ...
              <div>
                ...
                <p className="text-[#6B6B6B] text-sm">
                  Works completely offline. Ideal for secure environments with
                  no internet access.
                </p>
              </div>
            </div>
      ...
      <section className="py-24 bg-[#A3A380]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 mb-8 max-w-2xl mx-auto">
            Deploy सनdesh on your network today. No signup required, no cloud
            dependencies.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-[#8B8B8B] text-sm max-w-xs mb-4">
                A local-first, self-hosted email platform for private networks
                and organizations.
              </p>
