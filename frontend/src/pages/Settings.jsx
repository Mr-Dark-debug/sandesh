          ...
          <Card className="mb-6 bg-[#F6F8FC] border-[#E5E8EB] animate-[slideUp_150ms_ease]">
            <CardContent className="p-4">
              ...
              <div className="space-y-3 text-sm text-[#6B6B6B]">
                <p>
                  <strong className="text-[#3D3D3D]">Your email address</strong>{" "}
                  is automatically generated from your username and the system
                ...
                <p>
                  <strong className="text-[#3D3D3D]">Display name</strong> is
                  how you appear in emails and the UI. You can change this
                  anytime. Recipients will see:{" "}
                  <code className="bg-white px-1.5 py-0.5 rounded">
                    Display Name &lt;email@namespace&gt;
                  </code>
                </p>
                <p>
                  <strong className="text-[#3D3D3D]">Username</strong> is fixed
                  and cannot be changed because it's part of your email address.
                </p>
              </div>
            ...
            <div className="flex items-start gap-6">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-[#8B8B8B] uppercase tracking-wider mb-1">
                    Username{" "}
                    <span className="text-[#A3A380]">(cannot change)</span>
                  </label>
                ...
                <div>
                  <label className="block text-xs font-medium text-[#8B8B8B] uppercase tracking-wider mb-1">
                    Email Address{" "}
                    <span className="text-[#A3A380]">(read-only)</span>
                  </label>
                  <div className="flex items-center gap-2">
                    ...
                    >
                      {copied ? (
                        <Check className="w-4 h-4 text-[#7A9B6D]" />
                      ) : (
