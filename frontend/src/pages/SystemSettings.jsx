...
export default function SystemSettings() {
  ...
  const hasChanges =
    instanceName !== settings?.instance_name || namespace !== originalNamespace;
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-[#6B6B6B]">
              Configure your Sandesh instance
            </p>
          </div>
        </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-[#6B6B6B]">
                <p className="font-medium text-[#3D3D3D] mb-1">
                  About the Mail Namespace
                </p>
                <p>
                  The mail namespace defines how email addresses are generated
                  for all users. For example, with namespace "
                  <strong>{namespace}</strong>", a user "alice" will have the
                  email address:{" "}
        ...
        <Card className="mb-6">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <h2 className="font-semibold text-[#3D3D3D]">
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-[#8B8B8B]">
                2-20 characters, lowercase letters, numbers, and hyphens. Must
                start with a letter.
              </p>
            </div>
